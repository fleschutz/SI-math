...
```
1) What's the potential energy of just 1g mass? 89.9 TJ
2) What's the average speed of Kiptum's world record in Marathon? 21.1 km/h
3) What's the free fall time from Burj Khalifa tower in Dubai? 13.0 sec
4) What's the kinetic energy of a car at 50 km/h? 125.4 kJ
5) What's the average temperature of 0°C, 32°F, 491.67°R, and 273.15K? 0.0 °C (32.0 °F)
6) What's the average speed here? 1002.0 km/h
7) What's the wavelength of H2 in vacuum? 21.1 cm
8) What's the wavelength of the high 'c' music note? 32.8 cm
9) What's a radar's geometrical horizon (the distance it can see)? 10.8 km
10) What's the time needed to fly non-stop around the Earth at Mach 1? 1.4 days
11) What's the travel time of sun light to Earth? 8.3 min
12) What's the sum of 1 byte + 1kB + 1GB...(and so on)? 1.001e+30
13) What's the sum of 1m + 1NM + 1ft? 1.9 km
14) What's the population density on Earth (people per km² of land area)? 55.1 /km²
15) How much land area would be available for each person on Earth? 1.8 hm²
...
```
