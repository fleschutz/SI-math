...
LITERAL( km²,    1e6, meter2);              // 1_km²
LITERAL( m²,       1, meter2);              // 1_m²
LITERAL( cm²,   1e-4, meter2);              // 1_cm²
LITERAL( mm²,   1e-6, meter2);              // 1_mm²

LITERAL( km³,    1e9, meter3);              // 1_km³
LITERAL( m³,       1, meter3);              // 1_m³
