...
LITERAL(_Gm,     1e9, meter);               // 1_Gm (gigameter)
LITERAL(_Mm,     1e6, meter);               // 1_Mm (megameter)
LITERAL(_km,     1e3, meter);               // 1_km (kilometer)
LITERAL(_m,        1, meter);               // 1_m  (meter)
LITERAL(_dm,    1e-1, meter);               // 1_dm (decimeter)
LITERAL(_cm,    1e-2, meter);               // 1_cm (centimeter)
LITERAL(_mm,    1e-3, meter);               // 1_mm (millimeter)
LITERAL(_um,    1e-6, meter);               // 1_um (micrometer)
LITERAL(_nm,    1e-9, meter);               // 1_nm (nanometer)
LITERAL(_pm,   1e-12, meter);               // 1_pm (picometer)
// time in...
LITERAL(_day,  86400, second);              // 1_day (day on Earth)
LITERAL(_days, 86400, second);              // 2_days(day on Earth)
LITERAL(_h,     3600, second);              // 1_h   (hour)
LITERAL(_min,     60, second);              // 1_min (minute)
LITERAL(_s,        1, second);              // 1_s   (second)
LITERAL(_ms,    1e-3, second);              // 1_ms  (millisecond)
LITERAL(_us,    1e-6, second);              // 1_us  (microsecond)
LITERAL(_ns,    1e-9, second);              // 1_ns  (nanosecond)
LITERAL(_ps,   1e-12, second);              // 1_ps  (picosecond)
// mass in...
LITERAL(_Gt,    1e12, kilogram);            // 1_Gt (metric gigaton)
LITERAL(_Mt,     1e9, kilogram);            // 1_Mt (metric megaton)
LITERAL(_kt,     1e6, kilogram);            // 1_kt (metric kiloton)
LITERAL(_t,      1e3, kilogram);            // 1_t  (metric ton)
LITERAL(_kg,       1, kilogram);            // 1_kg
LITERAL(_g,     1e-3, kilogram);            // 1_g  (gram)
LITERAL(_mg,    1e-6, kilogram);            // 1_mg (milligram)
...
LITERAL(_Gpc,           30'856'775'814'913'673e9, meter);  // 1_Gpc (gigaparsec, as of IAU 2012)
LITERAL(_Mpc,           30'856'775'814'913'673e6, meter);  // 1_Mpc (megaparsec, as of IAU 2012)
LITERAL(_kpc,           30'856'775'814'913'673e3, meter);  // 1_kpc (kiloparsec, as of IAU 2012)
LITERAL(_pc,            30'856'775'814'913'673e0, meter);  // 1_pc  (parsec, as of IAU 2012)
LITERAL(_ly,               9'460'730'472'580'800, meter);  // 1_ly  (light-year)
LITERAL(_au,                     149'597'870'700, meter);  // 1_au  (astronomical unit)
// imperial units in...
LITERAL(_degF,                                 1, fahrenheit); // 1_degF (°Fahrenheit)
LITERAL(_ft,                               .3048, meter);  // 1_ft (feet)
LITERAL(_ft_per_min,                     0.00508, meters_per_second); // 1_ft_per_min (feet/min)
LITERAL(_in,                              0.0254, meter);  // 1_in (inch)
...
LITERAL(_lb,                          453.592'37, gram);   // 1_lb
LITERAL(_oz,                      28.349'523'125, gram);   // 1_oz
LITERAL(_mi,                           1'609.344, meter);  // 1_mi (statute mile)
LITERAL(_mph,                             .44704, meters_per_second); // 1_mph (miles per hour)
LITERAL(_NM,                               1'852, meter);  // 1_NM (nautical mile)
LITERAL(_nmi,                              1'852, meter);  // 1_nmi (nautical mile)
LITERAL(_yd,                               .9144, meter);  // 1_yd (yard)
// digital units in...
...
LITERAL(_Ang,                              1e-10, meter);    // 1_Ang  (angstrom)
