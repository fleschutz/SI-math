...
const csv_data_entry planets[] {
    ...
    {"Jupiter", 1898_kg, 142984_km, 1326_kg_per_m³, 23.1_m_per_s², 59.5_m_per_s, 9.9_h, 9.9_h, 778.6_kg, 740.5, 816.6, 4331_h, 13.1_m_per_s, 1.3, 0.049, 3.1, -110_degC, 000_bar, 79, true, true, },
    {"Saturn", 568_kg, 120536_km, 687_kg_per_m³, 9.0_m_per_s², 35.5_m_per_s, 10.7_h, 10.7_h, 1433.5_kg, 1352.6, 1514.5, 10747_h, 9.7_m_per_s, 2.5, 0.057, 26.7, -140_degC, 000_bar, 62, true, true, },
